...
Se necessário, você pode exportar esses resultados para um relatório para ver quais arquivos estão ou não sendo verificados devido às permissões. link:task-investigate-data.html#data-investigation-report["Saiba mais sobre o Relatório de Investigação de Dados"^] .
