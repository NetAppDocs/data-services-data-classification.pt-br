...
---
= Veja detalhes de conformidade sobre dados privados da organização com NetApp Data Classification
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Os detalhes de conformidade em nível de arquivo só estão disponíveis se você realizar uma verificação de classificação completa. Verificações somente de mapa não fornecem detalhes em nível de arquivo.
...
+
image:screenshot_compliance_investigation_page.png["Uma captura de tela com informações detalhadas encontradas nos arquivos após selecionar Investigate Results."]

+
image:screenshot_compliance_investigation_page_directory.png["Uma captura de tela com informações detalhadas encontradas nos diretórios após selecionar Investigate Results."]
...
. Investigue os dados pesquisando, classificando, expandindo detalhes de um arquivo específico, selecionando *Investigate Results* para ver informações mascaradas ou baixando a lista de arquivos.
