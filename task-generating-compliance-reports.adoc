...
---
= Visualize os relatórios de conformidade em NetApp Data Classification
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[NOTE]
====
* Os relatórios de conformidade só estão disponíveis se você realizar uma verificação completa de classificação em suas fontes de dados. Fontes de dados que passaram apenas por uma verificação de mapeamento podem gerar somente o Relatório de Mapeamento de Dados.
