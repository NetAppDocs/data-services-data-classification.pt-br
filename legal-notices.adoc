...
summary:  
---
= Avisos legais para NetApp Data Classification
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
* https://docs.netapp.com/us-en/console-setup-admin/media/notice.pdf["Aviso para o NetApp Console"^]
* link:media/notice-data-classification.pdf["Aviso para NetApp Data Classification"^]
