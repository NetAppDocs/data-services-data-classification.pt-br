...
summary: Para instalar NetApp Data Classification em um host Linux em sua rede ou em um host Linux na nuvem com acesso à internet, você precisa implantar o host Linux manualmente em sua rede ou na nuvem. 
---
= Instale NetApp Data Classification em um host com acesso à internet
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Para implantar NetApp Data Classification em um host Linux em sua rede ou em um host Linux na nuvem com acesso à internet, você precisa implantar o host Linux manualmente em sua rede ou na nuvem.
...
É necessário um agente de console antes que você possa instalar e usar NetApp Data Classification. Na maioria dos casos, você provavelmente já terá um agente de console configurado antes de tentar ativar NetApp Data Classification.
...
Na maioria das situações, você instala o Data Classification em um sistema de host único. Este não é o mesmo host de máquina virtual que o agente do Console. <<Instalação de host único para configurações típicas,Veja esses passos aqui>>.
...
.Passos
. Faça o download do software de Classificação de Dados em https://mysupport.netapp.com/site/products/all/details/cloud-data-sense/downloads-tab/["Site de suporte da NetApp"^]. Selecione o arquivo chamado *DATASENSE-INSTALLER-<version>.tar.gz*.
