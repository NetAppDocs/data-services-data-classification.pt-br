...
Para acessar o Swagger, você precisará do endereço IP da sua instância de NetApp Data Classification. No caso de uma implantação de nuvem, você usará o endereço IP público. Em seguida, você precisará acessar este endpoint:
