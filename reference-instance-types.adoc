...
[role="lead"]
O software NetApp Data Classification deve ser executado em um host que atenda aos requisitos específicos de sistema operacional, memória RAM e software. Ao implantar o Data Classification na nuvem, utilize um sistema com as características "large" para obter funcionalidade completa.
