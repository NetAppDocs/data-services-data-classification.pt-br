...
* *Análise profunda de classificação de dados (análise completa)*: A Classificação de Dados analisa dados usando protocolos padrão e permissão somente leitura em todos os seus ambientes. Arquivos selecionados são abertos e analisados em busca de dados confidenciais relacionados aos negócios, informações privadas e problemas relacionados a ransomware.
+
