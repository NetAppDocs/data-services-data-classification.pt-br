...
* *As varreduras somente de mapa* fornecem apenas uma visão geral de alto nível dos seus dados. O mapeamento pode ser feito em suas fontes de dados muito rapidamente, pois não acessa arquivos para visualizar os dados internos.
* As varreduras de *Mapear e classificar* fornecem uma varredura profunda dos seus dados.


Você pode se beneficiar do uso de varreduras somente de mapeamento para analisar rapidamente seus dados e identificar as fontes de dados que exigem mais pesquisa e, posteriormente, habilitar as varreduras de mapeamento e classificação apenas nessas fontes de dados ou volumes necessários.

A prioridade é atribuída somente a varreduras apenas de Map, não a varreduras de Map e classify.
