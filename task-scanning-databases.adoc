...
TIP: Não existe opção para selecionar varreduras somente de mapa para esquemas de banco de dados.

. Na página de Configuração, selecione o botão *Gerenciar* para o banco de dados que deseja configurar.
+
...
. Para cada esquema para o qual você deseja habilitar as varreduras, selecione a coluna *Tipo de varredura* e defina a varredura como desativada ou **Varredura completa**.
