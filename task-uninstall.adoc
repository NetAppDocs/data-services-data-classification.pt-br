...
. Selecione **Desinstalar Classificação de Dados**.
...
. Na caixa de diálogo, digite "desinstalar" para prosseguir com a desconexão da instância de Data Classification do agente do Console. Selecione **Desinstalar** para confirmar.
