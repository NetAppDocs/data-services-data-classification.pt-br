...
Se você ainda não possui um agente de Console, crie um agente de Console em seu provedor de nuvem. Consulte  https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-aws.html["criando um agente de console na AWS"^] ou  https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-azure.html["criando um agente de console no Azure"^], ou  https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-google.html["criando um agente de console no GCP"^]. Na maioria dos casos, você provavelmente já tem um agente de Console configurado antes de tentar ativar a Classificação de Dados porque a maioria  https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-on-prem.html["Os recursos do console exigem um agente do console"], mas há casos em que será necessário configurar um agora.
